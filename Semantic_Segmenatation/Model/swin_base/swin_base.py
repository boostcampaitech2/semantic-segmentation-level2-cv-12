...
model = dict(
    type='EncoderDecoder',
    pretrained=
    '/opt/ml/segmentation/mmsegmentation/configs/_selfmade/pretrained/upernet_swin_base_patch4_win12.pth',
    backbone=dict(
...
data = dict(
    ...
    train=dict(
        ...
        seg_map_suffix='.png',
        img_dir='/opt/ml/segmentation/input/data/images/train',
        ann_dir='/opt/ml/segmentation/input/data/annotations/train',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations'),
            dict(type='Resize', img_scale=(2048, 512), ratio_range=(0.5, 2.0)),
    ...
    val=dict(
        ...
        reduce_zero_label=False,
        seg_map_suffix='.png',
        img_dir='/opt/ml/segmentation/input/data/images/val',
        ann_dir='/opt/ml/segmentation/input/data/annotations/val',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
    ...
    test=dict(
        ...
        reduce_zero_label=False,
        seg_map_suffix='.png',
        img_dir='/opt/ml/segmentation/input/data/test',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                entity='bcaitech_cv2',
                name='upernet_vit-b16_mln_512x512_160k_ade20k_AdamW'))
    ])
